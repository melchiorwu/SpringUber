package com.chaoyu.spring.uber.rest;
...
public class FleetBulkUploadRestController {
    ...
    public Page<Location> findMovementByType(@PathVariable String movementType, @RequestParam(name = "page") int page, @RequestParam(name = "size") int size) {
